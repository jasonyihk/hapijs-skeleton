"use strict"
const logger = require("helpers/logger")('rspHandler');

exports.transform = async function (request) {
...
exports.alert = function (request) {
    ...
    let message = {
        ...
        error: source ? source.stacktrace : response.data
    }
    console.log(message);
};